...
public class FirstTweetFinderTest {
  ...
  public void setup() {
    when(api.getTweets()).thenReturn(
        Arrays.asList(new Tweet("base 1", null, new Date(1000), null, "Ophir"),
            new Tweet("base 2", null, new Date(2000), null, "Ziv"), new Tweet(
                "re: base 2", "base 2", new Date(3000), null, "Ophir"),
            new Tweet("re: base 1", "base 1", new Date(4000), null, "Ziv"),
            new Tweet("re: some tweet", "some tweet", new Date(1000), null,
                "Ziv")));
    $.visit(api);
